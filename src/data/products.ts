...
export const productsList: ProductItem[] = [
  {
    ...
    shortDescription: "Uma combinação de beterraba, baru e proteína vegetal pensada para acompanhar uma rotina ativa com máxima vitalidade e digestibilidade.",
    fullDescription: "O Power Nature é o primeiro produto da linha funcional da Raiz Vital. Desenvolvido com beterraba em pó desidratada, castanha de baru do Cerrado, proteína vegetal isolada e minerais naturais, entrega nutrição limpa sem corantes artificiais.",
    image: "/imagem-hero.webp",
    keyIngredients: ["Beterraba em Pó", "Castanha de Baru", "Proteína Vegetal", "Minerais Naturais"],
