...
export const ingredientsCatalogData: IngredientItem[] = [
  {
    ...
    role: "Cor vibrante característica, fonte natural de nitratos botânicos e minerais da terra.",
  ...
  },
  {
    ...
    role: "Superalimento nativo com perfil nobre de lipídios benéficos, proteínas e minerais.",
  ...
  },
  {
    ...
    name: "Proteínas de Origem Vegetal",
    scientificOrType: "Matriz 100% Plant-Based",
    origin: "Fontes Botânicas Sustentáveis",
    role: "Aporte proteico vegetal puro sem derivados lácteos, lactose ou subprodutos animais.",
    description: "Componente essencial para complementar a ingestão diária de aminoácidos, com rápida absorção, excelente perfil de solubilidade e total respeito ao estilo de vida consciente.",
    badge: "100% Vegetal",
    image: "https://images.unsplash.com/photo-1540420773420-3366772f4999?q=80&w=900&auto=format&fit=crop"
  },
  {
    id: "minerais-naturais",
    name: "Minerais & Eletrólitos Naturais",
    scientificOrType: "Potássio, Magnésio e Ferro",
    origin: "Matriz Vegetal Não Refinada",
    role: "Equilíbrio eletrolítico e mineral naturalmente presente nos ingredientes botânicos.",
    description: "Ao invés de aditivos sintéticos isolados, a Raiz Vital prioriza os minerais intrínsecos das próprias plantas e sementes para um suporte fisiológico equilibrado.",
